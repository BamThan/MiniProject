...
<template>
    ...
    <div>
                ...
                <div v-else class="dropdown dropdown-end">
                    <div tabindex="0" role="button" class="btn btn-ghost btn-circle avatar">
                        <div class="w-10 rounded-full">
                            <img src="https://i.pinimg.com/736x/48/0f/60/480f6004a79f326ee7d8f23662faae2c.jpg" />
                        </div>
                    </div>
                    <ul tabindex="0"
        ...
        <!-- Start FOOTER -->
        <footer
            class="footer footer-horizontal footer-center bg-warning-content/40 text-base-content rounded p-10 mt-10">
